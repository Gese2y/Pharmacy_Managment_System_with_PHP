  ...
  <form method="post" action="">
                                            <table class="table table-striped table-bordered dom-jQuery-events">
                                                 <thead>
                                                  ...
                                                  <tr>
                                                    <th><a button data-toggle="collapse" data-target="#dem1" class="btn btn-info">View other</a> </th>
                                                    <th>item name </th>
                                                    <th>unit </th>
                                                    <th>quantity</th>
                                                    <th>Item Price</th>
...
<?php 
     ...
     $sqlr="SELECT `Catagory_name`, `item_id`, `Item_name`, `unit`, `Quantity`, `Item_price`, `sales_price`, `Country`, `Produced_Date`, `Expired_date`, `Entered_date`, `Shelf_no`, `supplier_name`, `Record_by`, `Status` FROM `item` WHERE `Status`='Low Item' and store='Store 2'";
     ...
     if ($result ->num_rows > 0) {
      ...
      <tr>
        <th>
          <div class="card-content collapse" id="dem1">
            <div class="row">
 ...
 ?>
                              ...
                              <center> <a button data-toggle="collapse" data-target="#demo3" ><h2 ><b><u>Low Item in Mebrat Hayil</u></b></h2></a> </center>
  ...
  <form method="post" action="">
                                            <table class="table table-striped table-bordered dom-jQuery-events">
                                                 <thead>
                                                  ...
                                                  <tr>
                                                    <th><a button data-toggle="collapse" data-target="#dem2" class="btn btn-info">View other</a> </th>
                                                    <th>item name </th>
                                                    <th>unit </th>
                                                    <th>quantity</th>
                                                    <th>Item Price</th>
...
<?php 
     ...
     $sqlr="SELECT `Catagory_name`, `item_id`, `Item_name`, `unit`, `Quantity`, `Item_price`, `sales_price`, `Country`, `Produced_Date`, `Expired_date`, `Entered_date`, `Shelf_no`, `supplier_name`, `Record_by`, `Status` FROM `item` WHERE `Status`='Low Item' and store='Store 1'";
     $result = $con->query($sqlr);
     if ($result ->num_rows > 0) {
      while ($row = $result->fetch_array()) {
      $Itid=$row['item_id'];
      ...
      <tr>
        <th>
          <div class="card-content collapse" id="dem2">
            <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <img src="image/<?php echo $ro1['image']; ?> " alt="image" style="width: 50px; height: 50px">
