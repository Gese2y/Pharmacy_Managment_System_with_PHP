                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Expired Item Alert
                                </li>
                            </ol>
                        </div>
                    </div>
...
<?php 
     ...
     $sqlr="SELECT * FROM `alert2` where alert_title='expired_item' and status not like '%$Gname%' order by alert_date desc ";
