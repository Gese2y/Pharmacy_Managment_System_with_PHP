...
if (isset($_POST['search'])) {
  $d1=$_POST['d1'];
  $d2=$_POST['d2'];?>      
  <center> <a button data-toggle="collapse" data-target="#demo1" ><h2 ><b><u>Slightly Sold In Wollo Sefer</u></b></h2></a> </center>
...
<?php 
$sqlr="SELECT `item_id`, `Catagory_id`, `Item_name`, `unit`, `Quantity`, `Country`, `Sales_price`, `Sold_by`, `Customer_name`, `Sold_date`, Sum(Quantity) as SameValue from `sold_item` WHERE from_store='Store 2' and Sold_date BETWEEN '$d1' AND '$d2' GROUP BY item_id having sum(Quantity)<10";
 ...
 ?>
                              ...
                              <center> <a button data-toggle="collapse" data-target="#demo3" ><h2 ><b><u>Slightly Sold In Mebrat Hayil</u></b></h2></a> </center>
  ...
  <center>
                                              <form action="" method="POST">From: <input  type="date" placeholder="search by user name" name="d11"> To: <input  type="date" placeholder="search by user name" name="d21">
      <button type="submit" name="searchMeb" class="btn btn-primary">Open It</button>
  </form>
                                          </center>
...
<?php 
$sqlr="SELECT `item_id`, `Catagory_id`, `Item_name`, `unit`, `Quantity`, `Country`, `Sales_price`, `Sold_by`, `Customer_name`, `Sold_date`, Sum(Quantity) as SameValue from `sold_item` WHERE from_store='Store 1' and Sold_date BETWEEN '$d1' AND '$d2' GROUP BY item_id having sum(Quantity)< 10";
     $result = $con->query($sqlr);
     if ($result ->num_rows > 0) {
      while ($row = $result->fetch_array()) {
      ?>
