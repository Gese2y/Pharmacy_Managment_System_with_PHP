...
<?php 
     ...
     $sqlr="SELECT * FROM `request` WHERE sent_to='pharmacy' or sent_to='Manager'";
     ...
     if ($result ->num_rows > 0) {
      ...
      <tr>
        ...
        <th><?php echo $row['content'];?>
          <th><?php $st=$row['status'];
                if ($st=='accepted') {
                   ?><a href=""class="btn btn-success"><i ></i><?php echo $row['status'];?></a><?php
                 }else{ ?><a href="Up_request.php?id=<?php echo $row['request_id']; ?>"class="btn btn-primary"><i ></i><?php echo $row['status'];?></a><?php } ?></th></th>
