...
<!-- BEGIN: Content-->
                        ...
                        <div class="col-12">
                            <div class="card">
                              <div class="card-header">                                    
                                    <center><h2 ><b><u>Expired Item</u></b></a></h2></center>
  ...
  <center> <a button data-toggle="collapse" data-target="#demo1" ><h2 ><b><u>Expired Item In Wollo Sefer</u></b></h2></a> </center>
...
<?php 
     ...
     $sqlr="SELECT `Catagory_name`, `item_id`, `Item_name`, `unit`, `Quantity`, `Item_price`, `sales_price`, `Country`, `Produced_Date`, `Expired_date`, `Entered_date`, `Shelf_no`, `supplier_name`, `Record_by`, `Status` FROM `item` WHERE `Status`='Item Expired' and store='Store 2'";
 ...
 ?>
                              ...
                              <center> <a button data-toggle="collapse" data-target="#demo3" ><h2 ><b><u>Expired Item in Mebrat Hayil Branch</u></b></h2></a> </center>
  ...
  <form method="post" action="">
                                            <table class="table table-striped table-bordered dom-jQuery-events">
                                                 <thead>
                                                  ...
                                                  <tr>
                                                    <th><a button data-toggle="collapse" data-target="#demo2" class="btn btn-info">View other</a> </th>
                                                    <th>item name </th>
                                                    <th>unit </th>
                                                    <th>quantity</th>
                                                    <th>Item Price</th>
...
<?php 
     ...
     $sqlr="SELECT `Catagory_name`, `item_id`, `Item_name`, `unit`, `Quantity`, `Item_price`, `sales_price`, `Country`, `Produced_Date`, `Expired_date`, `Entered_date`, `Shelf_no`, `supplier_name`, `Record_by`, `Status` FROM `item` WHERE `Status`='Item Expired' and store='Store 1'";
     $result = $con->query($sqlr);
     if ($result ->num_rows > 0) {
      while ($row = $result->fetch_array()) {
      $Itid=$row['item_id'];
