...
if (empty($username)||empty($password)||empty($E_id)||empty($email)) {
    if ($username=="") {
  ...
  $sqlup="DELETE FROM user WHERE username='$username'";
    ...
    <form class="form-horizontal" action="" method="POST">
                      ...
                      <div class="form-group">
                          <div class="col-sm-offset-2 col-sm-10">
                             <center> <button type="submit" name="Update" class="btn btn-danger" onclick="return checkDelete()"><i class="glyphicon glyphicon-update"></i>Remove Account</button></center>
                          </div>
                        </div>
