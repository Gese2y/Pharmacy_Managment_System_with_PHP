...
<?php 
 if ($Branch=='Wollo Sefer Branch') {
    $SStore="Store 2"; 
    $sqlr="SELECT `Catagory_name`, `item_id`, `Item_name`, `unit`, `Quantity`, `Item_price`, `sales_price`, `Country`, `Produced_Date`, `Expired_date`, `Entered_date`, `Shelf_no`, `supplier_name`, `Record_by`, `Status` FROM `item` WHERE store='$SStore' ORDER BY Quantity DESC ";
    ...
    $SStore="Store 1"; 
    $sqlr="SELECT `Catagory_name`, `item_id`, `Item_name`, `unit`, `Quantity`, `Item_price`, `sales_price`, `Country`, `Produced_Date`, `Expired_date`, `Entered_date`, `Shelf_no`, `supplier_name`, `Record_by`, `Status` FROM `item` WHERE store='$SStore' AND ORDER BY Quantity DESC ";
     $result = $con->query($sqlr);
     $i=0;
     if ($result ->num_rows > 0) {
      while ($row = $result->fetch_array()) {
