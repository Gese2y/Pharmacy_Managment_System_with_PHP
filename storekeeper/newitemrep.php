                    ...
                    <div class="value breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">New Entered item
                                </li>
                            </ol>
                        </div>
                    </div>
  ...
  <form action="" method="POST">                   <div class="form-row">
    ...
    <div class="form-group col-md-4">
      <h5>From<span class="required">*</span></h5>
                                                        <div class="controls">
                                                            <input type="date" name="from" class="form-control mb-1" required data-validation-required-message="Genetic name is required" value="">
                                                        </div>                                               </select>
    </div>                                                  
    ...
    <div class="form-group col-md-4">
      <h5>To <span class="required">*</span></h5>
                                                        <div class="controls">
                                                            <input type="date" name="to" class="form-control mb-1" required data-validation-required-message="Genetic name is required" value="">
                                                        </div>
    </div>
    <div class="form-group col-md-4">
      <div class="control">
      <h5><span class="required">*</span></h5>
 <button type="submit" name="search" class="btn btn-primary"><i class="las la-search"> Open It</i></button>
...
<div class="row">
                                                <div class="col-lg-6 col-md-12">
                                                            ...
                                                            <input type="hidden" name="branch" value="<?php echo $row211['work_place'] ?>" >
...
<?php 
 if ($Branch=='Wollo Sefer Branch') {
    $SStore="Store 2"; 
    $sqlr="SELECT `Catagory_name`, `item_id`, `Item_name`, `unit`, `Quantity`, `Item_price`, `sales_price`, `Country`, `Produced_Date`, `Expired_date`, `Entered_date`, `Shelf_no`, `supplier_name`, `Record_by`, `Status` FROM `item` WHERE Entered_date BETWEEN '$from' AND '$to' AND store='$SStore' ";
