                    ...
                    <div class="value breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Never Sold
                                </li>
                            </ol>
                        </div>
                    </div>
...
if ($Branch=='Mebrat Hayil Branch') {
    $SStore="Store 1"; 
$sqlr="SELECT * FROM item WHERE NOT EXISTS (SELECT * FROM sold_item WHERE sold_item.item_id = item.item_id and Sold_date BETWEEN '$d1' AND '$d2' ) and store='$SStore' ORDER BY no ASC "; 
