...
$username=$_POST['username'];
  ...
  $email=$_POST['email'];
  $res=$_POST['role'];
 $sqlup="UPDATE `user` SET `username`='$username',`Email`='$email',`password`='$incryptedpas' WHERE username='$username'";
  ...
  $errors[]="this user name is not to you";
}}
?>
<style type="text/css">
     .main {
        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Remove Account</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Remove Account
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    <form class="form-horizontal" action="" method="POST">
                      ...
                      <div class="form-group">
                          <div class="col-sm-offset-2 col-sm-10">
                             <center> <button type="submit" name="Update" class="btn btn-success"><i class="glyphicon glyphicon-update"></i>Edit Account</button></center>
                          </div>
                        </div>
