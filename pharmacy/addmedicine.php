...
if (isset($_POST['Update'])) {
  ...
  $sqlm = "INSERT INTO item (`Catagory_name`, `item_id`, `Item_name`, `unit`, `Quantity`, `Item_price`, `sales_price`, `Country`, `Produced_Date`, `Expired_date`, `Entered_date`, `Shelf_no`, `supplier_name`, `Record_by`, `Status`)
       VALUES ('$category','$item_id','$item_name','$unit','$quan','$item_pr','$sale_price','$country','$pro_date','$ex_date','$E_date','$shelf_no','$supplier_name','$nameUs1','Avialable')";
...
$queryCat="SELECT * FROM `suppliers`";
  ...
  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" novalidate>
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <h5>Unit </h5>
                                                        <input type="text" name="unit" class="form-control mb-1" required data-validation-required-message="Genetic name is required" value="<?php echo $row['unit'] ?>">
                                                    </div>
