...
$all="SELECT item_id, sum(Quantity) as aTot from sold_item where from_store='$SStore' and Quantity>=10 and YEAR(Sold_date)=2020";
$resall=mysqli_query($con,$all);
$rowall=mysqli_fetch_array($resall);
$allc="SELECT item_id, count(item_id) as acTot from sold_item where from_store='$SStore' and Quantity>=10 and YEAR(Sold_date)=2020";
...
$rowallc=mysqli_fetch_array($resallc);
        ?>
                  ...
                  <div class="card-icon">
                    ...
                    <center><h2 class="text-white"><b><i class="material-icons">Mostlly Sold Item In <?php echo $Branch; ?> by this year</i></b></h2></center>
                  </div>
                  <h3 class="card-title text-white"># There Are <span class="text-primary"><i class="fa fa-long-arrow-up"></i>  <?php echo $rowallc['acTot']; ?></span> item mostlly solds, Totally <span class="text-primary"><i class="fa fa-long-arrow-up"></i>  <?php echo $rowall['aTot']; ?></span>    
