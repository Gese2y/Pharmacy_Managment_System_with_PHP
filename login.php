...
if(isset($_SESSION['username'])){
	$unam=$_SESSION['username'];
	           $r="SELECT role from user WHERE username='$unam'";
           $rr=mysqli_query($con,$r);
           $rF = $rr->fetch_array();
            $role=$rF['role'];
      if ($role=="Store Keeper") {
               header('location: storekeeper/home.php');
       } 
       else if ($role=="Pharmacist") {
               header('location: pharmacy/home.php');
       }
       else if ($role=="system admin") {
               header('location: system admin/adduser.php');
       }
  ...
  $password = md5($password); 
    ...
    if (mysqli_num_rows($results) == 1) { 
      ...
      $_SESSION['success'] = "You have logged in!";
           ...
           $r="SELECT role from user WHERE username='$username'";
           $rr=mysqli_query($con,$r);
           $rF = $rr->fetch_array();
            $role=$rF['role'];
      if ($role=="Store Keeper") {
               ...
               header('location: system admin/employee.php');
       }
       else if ($role=="Manager") {
               header('location: manager/home.php');
       }
...
<br>
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">LOGIN<span class="mx-2 mb-0">/</span> <strong class="text-black">Employee</strong></div>
        </div>
      </div>
<div class="">
    <div class="container">
