            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="">
                            <h1 class="brand-text" style="color: green"> <b> Gelead Pharmacy: <small><b><?php echo $res22;?></b></small></h1></b></h2>
                        </a></li>
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow" role="navigation" data-menu="menu-wrapper" >
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav navbar-right" id="main-menu-navigation" data-menu="menu-navigation" >
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="employee"><i class="la la-users"></i><span>Employee</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="adduser"><i class="la la-user-plus"></i><span>Create User Account</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="edituser"><i class="las la-user-edit"></i><span>Edit User</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="deleteuser"><i class="las la-user-minus"></i><span>Remove user</span></a></li>
