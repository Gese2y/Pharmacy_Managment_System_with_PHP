        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="index.php"><img class="background1"  src="facebook_profile_image1.jpg">
                            <h2 class="brand-text" style="color: green"> <b> : Admin</b></h2>
                        </a></li>
