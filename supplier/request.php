...
$branch=$_POST['branch'];
$rol= $res22;
       $sqlm = "INSERT INTO request ( sent_from, sender_role, contact, email, sent_to, sender_branch, title, content, sent_date, status) VALUES ('$from','$rol','$telephone','$email','$sent_to','Supplier','$title','$content','$today','Accept')";
